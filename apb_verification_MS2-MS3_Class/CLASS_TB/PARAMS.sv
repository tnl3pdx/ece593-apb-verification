package PARAMS;
	...
	parameter [ADDR_MSB_len-1:0] ADDR_SLAVE_2 = 2;  // ADDED: Address of slave_2 (Timer)
	...
	// UPDATED: Include the timer in the peripheral array
	parameter int PERIPH_TYPE[SLAVE_COUNT] = '{TYPE_MEM, TYPE_MEM, TYPE_TIMER};
